...
function create_main_fragment(component, state) {
	var div, text, text_1, div_1, div_2, text_6, div_3, text_7, div_4, div_4_class_value;
	...
	return {
		c: function create() {
			...
			div_2.innerHTML = "Disclaimer:<br>This documentation is a work in progress. It isn't ready and shouldn't be shared with outsiders until the removal of this message. If you want to help build it, please <a href=\"https://github.com/peercoin/docs#peercoin-official-documentation-repository\">click here</a>.";
			text_6 = createText("\n    ");
		...
		h: function hydrate() {
			div_2.className = "warn";
			div_3.className = "menu-swipper";
			div_4.className = div_4_class_value = "doc-container font-" + state.fontSize;
		...
		m: function mount(target, anchor) {
			...
			div_4.innerHTML = state.documentationHTML;
			component.refs.docContainer = div_4;
		},
		...
		p: function update(changed, state) {
			...
			if ((changed.fontSize) && div_4_class_value !== (div_4_class_value = "doc-container font-" + state.fontSize)) {
		...
		d: function destroy() {
			...
			if (component.refs.docContainer === div_4) component.refs.docContainer = null;
		}
	};
}
